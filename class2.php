...
<?php if ($debug): ?>
<pre style="white-space:pre-wrap;background:#fff7cc;border:1px solid #eedc82;padding:8px;margin-top:10px;">
DEBUG:
Targets: <?= count($targets) ?>; Competencies: <?= count($competencies) ?>
